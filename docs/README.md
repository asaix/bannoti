...
Step 5 is optional but recommended, because otherwise you will have to start Bannoti manually _every time you log on_, which could get annoying.
...
If you'd like to tip me via some other means, please [contact me](mailto:heyadityawork@gmail.com).
...
The tool that _sends the notifications_ is called [notify-rust](https://github.com/hoodie/notify-rust), and is distributed under [this license](https://github.com/hoodie/notify-rust/blob/main/LICENSE-Apache).
